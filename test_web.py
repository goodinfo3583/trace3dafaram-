...
if (!parentDoc.getElementById('custom-sticky-header')) {
    ...
    // 🚀 關鍵修正：將 href="?page=xxx" 改為 href="#"，並加入 data-target 對接傀儡按鈕
...
def change_page(page_name):
    ...
    # st.query_params["page"] = page_name  # 如果你需要網址也跟著變，可以取消註解這行

with st.container():
    # 這些按鈕會被上面的 JS 瞬間隱藏，使用者永遠看不到
