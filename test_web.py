...
def fetch_options_support_resistance_pandas(query_date):
    ...
    payload = {
        ...
        "commodity_id": "TXO",
        "commodity_id2": "",
        "queryDate": query_date, # 自動帶入 2026/05/29
        "MarketCode": "0",
        "commodity_idt": "TXO"
    }
    ...
    try:
        ...
        if target_df is None:
            return None, f"在 {query_date} 的網頁中找不到資料表格", None
