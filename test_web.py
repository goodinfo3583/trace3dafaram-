...
if not all_csv_files:
    ...
    if base_df is not None:
        ...
        # 4. 強健排序：依據最新日期數值排序
        latest_5d_col = f"{extract_date_from_name(target_files[0])[-4:]}買佔比%"
        ...
        st.error("❌ 無法讀取外資買超數據，請檢查欄位名稱是否包含『5日』與『成交』關鍵字。")
