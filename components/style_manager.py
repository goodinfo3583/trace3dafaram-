...
def render_course_npc():
    ...
    # =========================
    # 🎨 共用 CSS (加入手機 RWD 響應式設計)
    # =========================
    common_css = """
    <style>
    /* --- 桌面版預設樣式 --- */
    .npc-overlay {
        position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); /* 改為絕對置中 */
    ...
    @media (max-width: 768px) {
        ...
        .dialogue-box::before { display: none; /* 手機版隱藏對話框小箭頭，避免跑位 */ }
    ...
    # =========================
        ...
        courses_data = {
            ...
            'detail_4': {
                ...
                'html': """
                    <table class="pv-table" style="margin-top:10px;"><thead><tr><th width="15%">趨勢</th><th width="20%">狀態</th><th width="65%">市場含義</th></tr></thead>
                    <tbody>
            ...
            'detail_5': {
                ...
                'html': """
                    <div class="info-box"><b>🧭 指標核心雷達：</b><br>📈 MA 看方向 ｜ ⚡ MACD 看動能 ｜ 🌡️ RSI 看熱度 ｜ 🎢 KDJ 看短線節奏 ｜ 📏 BBW 看波動</div>
            ...
            'detail_6': {
                ...
                'html': """
                    <div class="section-title">📊 法人、大戶與分點怎麼看？</div>
            ...
            'detail_7': {
                ...
                'html': """
                    <table class="pv-table" style="margin-top:10px;"><thead><tr><th width="20%">趨勢</th><th width="35%">狀態</th><th width="45%">市場含義</th></tr></thead>
                    <tbody>
            ...
            'detail_8': {
                ...
                'html': """
                    <div class="info-box"><b style="color: #FFD700;">🎯 重點不是追熱門，而是問自己：</b><br>市場炒什麼？是單檔漲還是族群共振？有無基本面支撐？是剛起漲還是過熱？</div>
            ...
            'detail_9': {
                ...
                'html': """
                    <div class="info-box"><b style="color: #FFD700;">🛡️ 大原則：</b> 🟢 大盤越明確 → 提高配置 ｜ 🟡 大盤越震盪 → 分批操作 ｜ 🔴 大盤越弱 → 提高現金</div>
            ...
            'detail_10': {
                ...
                'html': """
                    <div class="info-box" style="border-color:rgba(255,76,76,0.3); background:rgba(255,76,76,0.05);"><b style="color: #FF4C4C;">⚠️ 致命陷阱：輸在太想賺！</b><br>一直交易不代表積極，而是不願等待。過度追求易導致：追高➔ 放大部位➔ 不願停損➔ <b>大虧損！</b></div>
