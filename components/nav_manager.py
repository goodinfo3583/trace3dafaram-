...
def inject_custom_header(is_logged_in=False):
    ...
    headerDiv.innerHTML = `
        <div class="disclaimer-bar">
            ...
            <div class="disclaimer-item"><a href="#" data-target="NavToContact" class="disclaimer-title internal-nav" style="cursor: pointer;">✉</span><div class="disclaimer-content">聯絡管家</div></div>
