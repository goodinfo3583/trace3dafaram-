...
def inject_custom_header(is_logged_in=False):
    ...
    headerDiv.innerHTML = `
        ...
        <div class="nav-btn-container" id="nav-btn-container">
            ...
            <a href="#" data-target="NavToWatchlist" class="nav-text-link internal-nav"><img src="app/static/icon-watchlist.png" class="nav-icon" alt="icon">建立名單</a><span class="nav-divider">|</span>
